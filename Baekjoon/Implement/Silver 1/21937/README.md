...
![](https://upload.acmicpc.net/3837e51f-ef9b-44c5-9028-92a0b2d99e21/-/crop/879x813/523,132/-/preview/)
...
- $1 \le N \le 100,000$
- $0 \le M \le min( \frac {N\times(N - 1)} {2}, 200000)$
- $1 \le A_i, B_i \le N$
- $1 \le X \le N$
...
- 문제를 만든 사람: [tony9402](https://www.acmicpc.net/user/tony9402)
- 문제를 검수한 사람: [melon940925](https://www.acmicpc.net/user/melon940925), [rhs0266](https://www.acmicpc.net/user/rhs0266)
