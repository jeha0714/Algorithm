...
첫째 줄에 배열의 크기 *N*이 주어진다. (2 ≤ *N* ≤ 10⁵)

둘째 줄에 배열의 원소 *aᵢ*가 공백으로 구분되어 *N*개 주어진다. (-10⁹ ≤ *aᵢ* ≤ 10⁹)
...
[University](https://www.acmicpc.net/category/5) > [연세대학교](https://www.acmicpc.net/category/334) > [2019 연세대학교 컴퓨터과학과 프로그래밍 경진대회](https://www.acmicpc.net/category/detail/2024) C번

- 문제를 만든 사람: [portableangel](https://www.acmicpc.net/user/portableangel)
